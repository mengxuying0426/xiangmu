...
public class FlowPopWindow extends PopupWindow {
    ...
    private void initPop() {
        View popView = View.inflate(context, com.zj.filters.R.layout.flow_pop_listview, null);
        //设置view
        ...
        mListView = (CustomHeightListView) popView.findViewById(com.zj.filters.R.id.listview);
        tvReset = (TextView) popView.findViewById(com.zj.filters.R.id.tv_reset);
        tvConfirm = (TextView) popView.findViewById(com.zj.filters.R.id.tv_confirm);
        nullView = popView.findViewById(com.zj.filters.R.id.view_null);

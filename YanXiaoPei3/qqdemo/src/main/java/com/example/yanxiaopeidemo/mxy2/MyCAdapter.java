...
public class MyCAdapter extends BaseAdapter {
     ...
     * 实例化Adapter
     */
    public MyCAdapter(Context context, List<SingleChoice> dataSet)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view= layoutinflater.inflate(R.layout.collect_tiitem, null);
            //获取控件
            ...
            holder.btnDetail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.setClass(myContext, CollectionTiActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK );
                    intent.putExtra("fenlei",mQList.get(position).getKeyNum()+"&"+mQList.get(position).getStem()+"&"+mQList.get(position).getOptionA()+"&"+
                            mQList.get(position).getOptionB()+"&"+mQList.get(position).getOptionC()+"&"+mQList.get(position).getOptionD()+"&"+mQList.get(position).getCorrect()
                    +"&"+mQList.get(position).getAnalysis());

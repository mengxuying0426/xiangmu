package com.example.yanxiaopeidemo.Activity;
...
import com.example.yanxiaopeidemo.entitys.MyDataSet;
...
public class ActionButtonActivity extends AppCompatActivity {
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {//当调用notifyDataSetChanged方法时会自动执行此方法
            ...
            TextView textViewLeft =view.findViewById(R.id.chatitemleft);
            TextView textViewRight =view.findViewById(R.id.chatitemright);
            left =view.findViewById(R.id.profile_image);
            right =view.findViewById(R.id.profile_imag);

//            TextView tvFromTime=view.findViewById(R.id.tv_from_time);
//            TextView tvToTime=view.findViewById(R.id.tv_to_time);
//            Date date=new Date();
//            SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
            ...
            if(dataList.get(position).getPlace().equals("left")){
                ...
                // tvFromTime.setText(format.format(date));
            }else{
                ...
                //   tvToTime.setText(format.format(date));
            }
            return view;
        }
    }

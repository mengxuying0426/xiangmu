...
public class FindWayActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_findway);
                ...
                case 0x00:
                    ...
                    if (result == SMSSDK.RESULT_COMPLETE) { //回调  当返回的结果是complete
                        if (event == SMSSDK.EVENT_GET_VERIFICATION_CODE) { //获取验证码
                            Toast.makeText(FindWayActivity.this, "发送验证码成功", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(FindWayActivity.this, "提交验证码成功", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(FindWayActivity.this, MainActivity.class);
                            startActivity(intent);
                        } else {
                            System.out.println("没走上边");
                        ...
                        try {
                            ...
                            if (status > 0 && !TextUtils.isEmpty(des)) {
                                Toast.makeText(FindWayActivity.this, des, Toast.LENGTH_SHORT).show();
                                return;
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
